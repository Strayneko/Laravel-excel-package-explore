<div>
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
        ...
        <h1 class="text-gray-900 text-xl">Sample 1: </h1>
        ...
        <form action="" wire:submit="submit">
            <div class="mt-6">
                ...
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50" id="file_input" wire:model="form.file" type="file">
                <div>
